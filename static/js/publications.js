...
function pubsTransfer(pubs) {
    return pubs
        ...
        .map((pub, pId) => ({
            ...pub,
            index: pId,
            authorIndex: pub.author.indexOf('Han Wang'),
            teaser: pub.teaser === ''
    ...
    return r('div', // pub root
        ...
        r('div', // info container
            ...
            r('div', // actions & markers
                ...
                pub.markers.includes('early access') && renderTag('Early Access', null, 'disabled'),
                pub.markers.includes('accept') && renderTag('Accepted', null, 'disabled'),
                pub.markers.includes('conditional acceptance') && renderTag('Conditionally Accepted', null, 'disabled'),
